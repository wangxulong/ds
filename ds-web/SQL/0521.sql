...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-05-21 17:39:41
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(65, '5555555555', '55555555555555', 1, 0, 49, '/ds/upload/material/1//test/82434500177761773.jpg'),
...
INSERT INTO `t_note` (`id`, `title`, `content`, `student_id`, `course_id`, `status`, `time`) VALUES
(1, '病假条', '最近身体不舒服，不能来上课，希望老师批准', 2, 1, 2, '2016-05-20 00:00:00'),
(2, '事假条', '家里有急事，不能准时上上课，希望老师批准', 2, 1, 0, '2016-05-21 00:00:00');
...
INSERT INTO `t_seminar` (`id`, `name`, `desc`, `start_time`, `end_time`, `course_id`) VALUES
...
INSERT INTO `t_seminar_topic` (`id`, `name`, `desc`, `demand`, `seminar_id`) VALUES
...
(1, '体育', ' 为同一家', '2016-05-12 05:57:35', '2016-05-20 00:00:00', 1, 1, NULL),
