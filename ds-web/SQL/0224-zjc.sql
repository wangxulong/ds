...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-05-24 15:52:17
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
--
-- 表的结构 `r_student_topic`
--

CREATE TABLE IF NOT EXISTS `r_student_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `student_id` int(11) DEFAULT NULL,
...
--
-- 转存表中的数据 `r_student_topic`
--

INSERT INTO `r_student_topic` (`id`, `student_id`, `topic_id`, `type`, `score`, `level`) VALUES
(4, 2, 2, 2, 123, 'A+');
...
INSERT INTO `t_exam` (`id`, `title`, `description`, `start_time`, `end_time`, `score`, `year`, `term`, `teacher_id`, `course_id`) VALUES
(1, '春季考试试卷', '这是一个简单的测试', '2016-05-20 00:00:00', '2016-05-19 00:00:00', NULL, 2016, 1, 1, 1);
...
(2, '事假条', '家里有急事，不能准时上上课，希望老师批准', 2, 1, 1, '2016-05-21 00:00:00', NULL);
...
INSERT INTO `t_seminar_topic` (`id`, `name`, `descp`, `demand`, `status`, `start_time`, `end_time`, `pnum`, `seminar_id`) VALUES
(1, '我从哪里来', '请同学们论述我从哪里来这个话题', '1.PPT\r\n2.论文', 4, '2016-06-01 00:00:00', '2016-06-02 00:00:00', 5, 1),
(2, '要到哪里去', '请同学们论述要到哪里去这个话题', '1.PPT\r\n2.论文', 3, '2016-06-08 00:00:00', '2016-06-09 00:00:00', 3, 1),
(4, '我是谁', '请同学们论述我是谁这个话题', '1.PPT\r\n2.论文', 0, '2016-06-15 00:00:00', '2016-06-16 00:00:00', 0, 1),
(5, '人类的起源', '人类的起源', '1、PPT\r\n2、论文', 0, '2016-06-22 00:00:00', '2016-06-23 00:00:00', 0, 2),
(7, '234234234', '23423423', '23423423', 0, '2016-06-09 00:00:00', '2016-06-15 00:00:00', 0, 2);
...
(1, 'wxl', 1, '410426199004025559', NULL, '15721377', '1993-07-22', NULL, NULL, '2016-05-12 14:58:59', '有趣风魔', '讲师', 0),
