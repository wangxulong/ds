...
<div class="modal-header">
  <h4 class="blue bigger">题目</h4>
</div>

<div style="margin-top:20px;">
<form:form class="form-horizontal" role="form" id="formSysRole" action="${ctx}/class/seminarTopic/save" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <div class="col-sm-9">
        <form:textarea path="demand" cols="3" placeholder="要求" class="form-control" />
      </div>
    </div>
  </div>
