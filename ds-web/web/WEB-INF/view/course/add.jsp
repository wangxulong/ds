...
<div class="modal-header">
  ...
  <h4 class="blue bigger">开设新课程</h4>
</div>


  <form:form class="form-horizontal" role="form" id="formSysRole" action="${ctx}/course/save" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <div class="col-sm-9">
          <form:input path="name" placeholder="课程名字" class="form-control" />
        </div>
      </div>
    </div>
    <div class="form-group">
